      ...
      <section className="pink-bg">
        <div className="w-layout-blockcontainer container-regular _2col wide w-container">
          ...
          <div className="_2-col-content">
            ...
            <div>
              <p className="h2 page-h2 flex-50 intro-copy question-title">
                How will monetization work?
              </p>
              <p className="h2 page-h2 intro-copy">Whenever someone uses the system to create a crypto solution—-such as tokenizing a real-world asset or establishing a financial supply chain—the system will negotiate a small share of the assets being created or transacted. Over time, a diverse portfolio of tokens will be aggregated and managed autonomously.</p>
            </div>
          </div>
        </div>
      </section>
